...
namespace Infoline.WorkOfTime.BusinessAccess
{
    ...
    partial class WorkOfTimeDatabase
    {
        ...
        public SummaryHeadersAdvance GetVWPA_AdvancesRequestByUserId(Guid userId, DbTransaction tran = null)
        {
            using (var db = GetDB(tran))
            {
                var headers = new SummaryHeadersAdvance();
                ...
                {
                    title = "Onay Bekleyenler",
                    filter = "{'Filter':{'Operand1':{'Operand1':{'Operand1':'confirmationStatus','Operator':'Equal','Operand2':'1'},'Operand2':{'Operand1':'confirmationStatus','Operator':'IsNull','Operand2':null},'Operator':'Or'},'Operand2':{'Operand1':{'Operand1':'direction','Operator':'Equal','Operand2':'0'},'Operand2':{'Operand1':'confirmationUserIds','Operator':'Like','Operand2':'%" + userId.ToString() + "%'},'Operator':'And'},'Operator':'And'}}",
                    count = db.Table<VWPA_Advance>().Where(a => (a.confirmationStatus == 1 || a.confirmationStatus == null) && a.direction == 0 && a.confirmationUserIds.Contains(userId.ToString())).Count(),
                    isActive = true
                });
                ...
                {
                    title = "Onaylananlar",
                    filter = "{'Filter':{'Operand1':{'Operand1':'confirmUserIds','Operator':'Like','Operand2':'%" + userId.ToString() + "%'},'Operand2':{'Operand1':{'Operand1':{'Operand1':'confirmationStatus','Operator':'Equal','Operand2':'1'},'Operand2':{'Operand1':'confirmationStatus','Operator':'IsNull','Operand2':null},'Operator':'Or'},'Operand2':{'Operand1':{'Operand1':'direction','Operator':'Equal','Operand2':'-1'},'Operand2':{'Operand1':'confirmationUserIds','Operator':'Like','Operand2':'%" + userId.ToString() + "%'},'Operator':'And'},'Operator':'And'},'Operator':'Or'}}",
                    count = db.Table<VWPA_Advance>().Where(a => a.confirmUserIds.Contains(userId.ToString()) || ((a.confirmationStatus == 1 || a.confirmationStatus == null) && (a.direction == -1 && a.confirmationUserIds.Contains(userId.ToString())))).Count(),
                    isActive = true
                });

                headers.headerFilters.Filters.Add(new HeadersAdvanceItem
                {
                    title = "Düzeltme Bekleyenler",
                    filter = "{'Filter':{'Operand1':{'Operand1':{'Operand1':'confirmationStatus','Operator':'Equal','Operand2':'1'},'Operand2':{'Operand1':'confirmationStatus','Operator':'IsNull','Operand2':null},'Operator':'Or'},'Operand2':{'Operand1':{'Operand1':'direction','Operator':'Equal','Operand2':'3'},'Operand2':{'Operand1':'confirmationUserIds','Operator':'Like','Operand2':'%" + userId.ToString() + "%'},'Operator':'And'},'Operator':'And'}}",
                    count = db.Table<VWPA_Advance>().Where(a => (a.confirmationStatus == 1 || a.confirmationStatus == null) && a.direction == 3 && a.confirmationUserIds.Contains(userId.ToString())).Count(),
                    isActive = false
                });
                ...
                {
                    title = "Reddedilenler",
                    filter = "{'Filter':{'Operand1':{'Operand1':'rejectedUserIds','Operator':'Like','Operand2':'%" + userId.ToString() + "%'},'Operand2':{'Operand1':{'Operand1':{'Operand1':'confirmationStatus','Operator':'Equal','Operand2':'1'},'Operand2':{'Operand1':'confirmationStatus','Operator':'IsNull','Operand2':null},'Operator':'Or'},'Operand2':{'Operand1':{'Operand1':'direction','Operator':'Equal','Operand2':'2'},'Operand2':{'Operand1':'confirmationUserIds','Operator':'Like','Operand2':'%" + userId.ToString() + "%'},'Operator':'And'},'Operator':'And'},'Operator':'Or'}}",
                    count = db.Table<VWPA_Advance>().Where(a => a.rejectedUserIds.Contains(userId.ToString()) || ((a.confirmationStatus == 1 || a.confirmationStatus == null) && a.direction == 2 && a.confirmationUserIds.Contains(userId.ToString()))).Count(),
                    isActive = true
                });
