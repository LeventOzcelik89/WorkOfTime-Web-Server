    ...
    partial class WorkOfTimeDatabase
    {
        ...
        public SummaryHeadersTransaction GetVWPA_TransactionsMyApprovedByUserId(Guid userId, DbTransaction tran = null)
        {
            using (var db = GetDB(tran))
            {
                ...
                {
                    title = "Onaylananlar",
                    filter = "{'Filter':{'Operand1':{'Operand1':'confirmUserIds','Operand2':'%" + userId.ToString() + "%','Operator':'Like'},'Operand2':{'Operand1':{'Operand1':{'Operand1':{'Operand1':'confirmationStatus','Operand2':1,'Operator':'Equal'},'Operand2':{'Operand1':'confirmationStatus','Operand2':null,'Operator':'IsNull'},'Operator':'Or'},'Operand2':{'Operand1':{'Operand1':'direction','Operand2':1,'Operator':'Equal'},'Operand2':{'Operand1':'type','Operand2':8,'Operator':'Equal'},'Operator':'And'},'Operator':'And'},'Operand2':{'Operand1':'confirmUserIds','Operand2':'%" + userId.ToString() + "%','Operator':'Like'},'Operator':'And'},'Operator':'Or'}}",
                ...
                {
                    title = "Reddedilenler",
                    filter = "{'Filter':{'Operand1':{'Operand1':'rejectedUserIds','Operand2':'%" + userId.ToString() + "%','Operator':'Like'},'Operand2':{'Operand1':{'Operand1':{'Operand1':'confirmationStatus','Operand2':1,'Operator':'Equal'},'Operand2':{'Operand1':'confirmationStatus','Operand2':null,'Operator':'IsNull'},'Operator':'Or'},'Operand2':{'Operand1':{'Operand1':{'Operand1':'direction','Operand2':2,'Operator':'Equal'},'Operand2':{'Operand1':'type','Operand2':8,'Operator':'Equal'},'Operator':'And'},'Operand2':{'Operand1':'confirmationUserIds','Operand2':'%" + userId.ToString() + "%','Operator':'Like'},'Operator':'And'},'Operator':'And'},'Operator':'Or'}}",
