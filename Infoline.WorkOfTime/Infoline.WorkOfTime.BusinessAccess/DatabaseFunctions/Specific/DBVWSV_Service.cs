...
namespace Infoline.WorkOfTime.BusinessAccess
{
    ...
    public enum EnumSV_ServiceActions
    {
        ...
        PrintEnd = 500,
        [Description("Fiyat Onayı Alındı"), Generic("icon", "fa fa-check", "color", "04C8B4", "description", "Fiyat Onayı Alındı", "attr", "data-model=true data-enum=501 id=transferstart  data-href=/SV/VWSV_ServiceOperation/CostOperation?serviceId={{}}&status=501 data-task=Insert data-method=GET")]
        CostAccepted = 501,
        [Description("Fiyat Onayı Reddedildi"), Generic("icon", "fa  fa-exclamation-triangle", "color", "E51010", "description", "Fiyat Onayı Reddedildi", "attr", "data-model=true data-enum=502 id=transferstart  data-href=/SV/VWSV_ServiceOperation/CostOperation?serviceId={{}}&status=502 data-task=Insert data-method=GET")]
        CostDenied = 502,
