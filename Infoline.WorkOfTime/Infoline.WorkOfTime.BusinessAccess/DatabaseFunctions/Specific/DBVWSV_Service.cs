...
namespace Infoline.WorkOfTime.BusinessAccess
{
    ...
    public enum EnumSV_ServiceActions
    {
        ...
        QualityControl = 201,
        [Description("Süreci Tamamla"), Generic("icon", "fa fa-check", "color", "dc1212", "description", "Süreci Tamamla", "attr", "data-model=false data-enum=300 id=transferstart data-ask data-href=/SV/VWSV_ServiceOperation/NextStage?serviceId={{}}&status=300 data-task=Insert data-method=POST ")]
        Done = 300,
