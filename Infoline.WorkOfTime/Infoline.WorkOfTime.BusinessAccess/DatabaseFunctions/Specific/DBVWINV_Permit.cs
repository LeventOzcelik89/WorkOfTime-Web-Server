...
namespace Infoline.WorkOfTime.BusinessAccess
{
    ...
    {
        public class SummaryHeadersPermitNew
        {
        ...
        public SummaryHeadersPermitNew GetVWINV_PermitMyPermitCountFilter(Guid userId, DbTransaction tran = null)
        {
            using (var db = GetDB(tran))
            {
                var headers = new SummaryHeadersPermitNew { };
                ...
                {
                    title = "Onay Beklenen",
                    filter = "{'Filter':{'Operand1':{'Operand1':'IdUser','Operand2':'" + userId.ToString() + "','Operator':'Equal'},'Operand2':{'Operand1':{'Operand1':'ApproveStatus','Operand2':'0','Operator':'Equal'},'Operand2':{'Operand1':{'Operand1':'ApproveStatus','Operand2':'1','Operator':'Equal'},'Operand2':{'Operand1':'ApproveStatus','Operand2':'3','Operator':'Equal'},'Operator':'Or'},'Operator':'Or'},'Operator':'And'}}",
                    count = db.Table<VWINV_Permit>().Where(a => a.IdUser == userId && (a.ApproveStatus == (int)EnumINV_PermitApproveStatus.TalepEdildi || a.ApproveStatus == (int)EnumINV_PermitApproveStatus.Yonetici1Onay || a.ApproveStatus == (int)EnumINV_PermitApproveStatus.Yonetici2Onay)).Count(),
                    isActive = true
                });
                ...
                headers.headerFilters.Filters.Add(new HeadersTaskItem
                {
                    ...
                    filter = "{'Filter':{'Operand1':{'Operand1':'IdUser','Operand2':'" + userId.ToString() + "','Operator':'Equal'},'Operand2':{'Operand1':'ApproveStatus','Operand2':'5','Operator':'Equal'},'Operator':'And'}}",
                    count = db.Table<VWINV_Permit>().Where(a => a.IdUser == userId && a.ApproveStatus == (int)EnumINV_PermitApproveStatus.IkKontrol).Count(),
                    isActive = false
                });
                ...
                {
                    title = "Onaylanan",
                    filter = "{'Filter':{'Operand1':{'Operand1':'IdUser','Operand2':'" + userId.ToString() + "','Operator':'Equal'},'Operand2':{'Operand1':{'Operand1':'ApproveStatus','Operand2':'7','Operator':'Equal'},'Operand2':{'Operand1':{'Operand1':'ApproveStatus','Operand2':'8','Operator':'Equal'},'Operand2':{'Operand1':{'Operand1':'ApproveStatus','Operand2':'9','Operator':'Equal'},'Operand2':{'Operand1':'ApproveStatus','Operand2':'10','Operator':'Equal'},'Operator':'Or'},'Operator':'Or'},'Operator':'Or'},'Operator':'And'}}",
                    count = db.Table<VWINV_Permit>().Where(a => a.IdUser == userId && (a.ApproveStatus == (int)EnumINV_PermitApproveStatus.IslakImzaYuklendi || a.ApproveStatus == (int)EnumINV_PermitApproveStatus.GecmisIzin || a.ApproveStatus == (int)EnumINV_PermitApproveStatus.SaglikRaporu || a.ApproveStatus == (int)EnumINV_PermitApproveStatus.AvansIzin)).Count(),
                    isActive = true
                });
                ...
                {
                    title = "Reddedilmiş",
                    filter = "{'Filter':{'Operand1':{'Operand1':'IdUser','Operand2':'" + userId.ToString() + "','Operator':'Equal'},'Operand2':{'Operand1':{'Operand1':'ApproveStatus','Operand2':'2','Operator':'Equal'},'Operand2':{'Operand1':{'Operand1':'ApproveStatus','Operand2':'4','Operator':'Equal'},'Operand2':{'Operand1':'ApproveStatus','Operand2':'6','Operator':'Equal'},'Operator':'Or'},'Operator':'Or'},'Operator':'And'}}",
                    count = db.Table<VWINV_Permit>().Where(a => a.IdUser == userId && (a.ApproveStatus == (int)EnumINV_PermitApproveStatus.Yonetici1Red || a.ApproveStatus == (int)EnumINV_PermitApproveStatus.Yonetici2Red || a.ApproveStatus == (int)EnumINV_PermitApproveStatus.IkKontrolRed)).Count(),
                    isActive = true
                });
        ...
        public SummaryHeadersPermitNew GetVWINV_PermitRequestPermitCountFilter(Guid userId, DbTransaction tran = null)
        {
            using (var db = GetDB(tran))
            {
                var headers = new SummaryHeadersPermitNew { };
                ...
                {
                    title = "Onay Beklenen",
                    filter = "{'Filter':{'Operand1':{'Operand1':{'Operand1':{'Operand1':'Manager1Approval','Operand2':'" + userId.ToString() + "','Operator':'Equal'},'Operand2':{'Operand1':'ApproveStatus','Operand2':'0','Operator':'Equal'},'Operator':'And'},'Operand2':{'Operand1':{'Operand1':'Manager2Approval','Operand2':'" + userId.ToString() + "','Operator':'Equal'},'Operand2':{'Operand1':'ApproveStatus','Operand2':'1','Operator':'Equal'},'Operator':'And'},'Operator':'Or'},'Operand2':{'Operand1':{'Operand1':'IkApproval','Operand2':'" + userId.ToString() + "','Operator':'Equal'},'Operand2':{'Operand1':'ApproveStatus','Operand2':'3','Operator':'Equal'},'Operator':'And'},'Operator':'Or'}}",
                    count = db.Table<VWINV_Permit>().Where(a => (a.Manager1Approval == userId && a.ApproveStatus == (int)EnumINV_PermitApproveStatus.TalepEdildi) || (a.Manager2Approval == userId && a.ApproveStatus == (int)EnumINV_PermitApproveStatus.Yonetici1Onay) || (a.IkApproval == userId && a.ApproveStatus == (int)EnumINV_PermitApproveStatus.Yonetici2Onay)).Count(),
                    isActive = true
                });
                ...
                {
                    title = "Onaylanan",
                    filter = "{'Filter':{'Operand1':{'Operand1':{'Operand1':{'Operand1':{'Operand1':{'Operand1':'ApproveStatus','Operator':'Equal','Operand2':'1'},'Operand2':{'Operand1':'ApproveStatus','Operator':'Equal','Operand2':'3'},'Operator':'Or'},'Operand2':{'Operand1':{'Operand1':'ApproveStatus','Operator':'Equal','Operand2':'5'},'Operand2':{'Operand1':'ApproveStatus','Operator':'Equal','Operand2':'7'},'Operator':'Or'},'Operator':'Or'},'Operand2':{'Operand1':'Manager1Approval','Operator':'Equal','Operand2':'" + userId.ToString() + "'},'Operator':'And'},'Operand2':{'Operand1':{'Operand1':{'Operand1':{'Operand1':'ApproveStatus','Operator':'Equal','Operand2':'3'},'Operand2':{'Operand1':'ApproveStatus','Operator':'Equal','Operand2':'7'},'Operator':'Or'},'Operand2':{'Operand1':'ApproveStatus','Operator':'Equal','Operand2':'5'},'Operator':'Or'},'Operand2':{'Operand1':'Manager2Approval','Operator':'Equal','Operand2':'" + userId.ToString() + "'},'Operator':'And'},'Operator':'Or'},'Operand2':{'Operand1':{'Operand1':{'Operand1':'ApproveStatus','Operator':'Equal','Operand2':'5'},'Operand2':{'Operand1':'ApproveStatus','Operator':'Equal','Operand2':'7'},'Operator':'Or'},'Operand2':{'Operand1':'IkApproval','Operator':'Equal','Operand2':'" + userId.ToString() + "'},'Operator':'And'},'Operator':'Or'}}",
                    count = db.Table<VWINV_Permit>().Where(a => ((a.ApproveStatus == (int)EnumINV_PermitApproveStatus.Yonetici1Onay || a.ApproveStatus == (int)EnumINV_PermitApproveStatus.Yonetici2Onay || a.ApproveStatus == (int)EnumINV_PermitApproveStatus.IkKontrol || a.ApproveStatus == (int)EnumINV_PermitApproveStatus.IslakImzaYuklendi) && a.Manager1Approval == userId) || ((a.ApproveStatus == (int)EnumINV_PermitApproveStatus.Yonetici2Onay || a.ApproveStatus == (int)EnumINV_PermitApproveStatus.IkKontrol || a.ApproveStatus == (int)EnumINV_PermitApproveStatus.IslakImzaYuklendi) && a.Manager2Approval == userId) || ((a.ApproveStatus == (int)EnumINV_PermitApproveStatus.IkKontrol || a.ApproveStatus == (int)EnumINV_PermitApproveStatus.IslakImzaYuklendi) && a.IkApproval == userId)).Count(),
                    isActive = true
                });
                ...
                {
                    title = "Reddedilmiş",
                    filter = "{'Filter':{'Operand1':{'Operand1':{'Operand1':{'Operand1':'Manager1Approval','Operator':'Equal','Operand2':'" + userId.ToString() + "'},'Operand2':{'Operand1':'ApproveStatus','Operator':'Equal','Operand2':'2'},'Operator':'And'},'Operand2':{'Operand1':{'Operand1':'Manager2Approval','Operator':'Equal','Operand2':'" + userId.ToString() + "'},'Operand2':{'Operand1':'ApproveStatus','Operator':'Equal','Operand2':'4'},'Operator':'And'},'Operator':'Or'},'Operand2':{'Operand1':{'Operand1':'IkApproval','Operator':'Equal','Operand2':'" + userId.ToString() + "'},'Operand2':{'Operand1':'ApproveStatus','Operator':'Equal','Operand2':'6'},'Operator':'And'},'Operator':'Or'}}",
                    count = db.Table<VWINV_Permit>().Where(a => (a.Manager1Approval == userId && a.ApproveStatus == (int)EnumINV_PermitApproveStatus.Yonetici1Red) || (a.Manager2Approval == userId && a.ApproveStatus == (int)EnumINV_PermitApproveStatus.Yonetici2Red) || (a.IkApproval == userId && a.ApproveStatus == (int)EnumINV_PermitApproveStatus.IkKontrolRed)).Count(),
                    isActive = true
                });
