        ...
        public ResultStatus Insert(INV_Permit item)
        {
            ...
            switch ((EnumINV_PermitApproveStatus)item.ApproveStatus)
            {
                ...
                case EnumINV_PermitApproveStatus.Yonetici1Red:
                    ...
                    notification.NotificationSend(manager2.id, "İzin Talebi Onayı Hakkında", notify2);
                    break;
                ...
                case EnumINV_PermitApproveStatus.Yonetici2Red:
                    ...
                    notification.NotificationSend(IKYonetici.id, "İzin Talebi Onayı Hakkında", notify3);
                    break;
                ...
                case EnumINV_PermitApproveStatus.IkKontrolRed:
                    ...
                    notification.NotificationSend(personel.id, "İzin Talebi Onayı Hakkında", mesaj4);
                    break;
