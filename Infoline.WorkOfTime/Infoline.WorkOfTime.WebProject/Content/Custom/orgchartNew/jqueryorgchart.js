    ...
    OrgChart.prototype = {
        ...
        exportPNG: function(canvas, exportFilename) {
            ...
            if ((!isWebkit && !isFf) || isEdge) {
                ...
                //Eğer istenirse png formatında indirmek için  [0] dan sonra .click() ekleyin.ve b64topdf fonksiyonunu kaldırın
                $chartContainer.find(selector).attr('href', canvas.toDataURL())[0];
                b64toPdf();
            }
        },
        //
