...
(function ($) {
    ...
    Calendar.prototype = {
        ...
        _initializeOptions: function (opt) {
            ...
            this.options = {
                ...
                language: (opt.language != null && dates[opt.language] != null) ? opt.language : 'TR',
        ...
        _renderBody: function () {
            ...
            for (var m = 0; m < 12; m++) {
                ...
                monthDiv.addClass('month-container col-md-4 col-lg-3 col-s-12');
                monthDiv.append('<span class="monthMenu" data-toggle="tooltip" data-placement="left" title="Görevler" data-month="' + (m + 1) + '"></span>');
        ...
        _applyEvents: function () {
            ...
            //    monthContainerClass += ' col-md-4 col-s-12';
    ...
    var dates = $.fn.calendar.dates = {
        TR: {
            ...
            daysShort: ["Pz", "Pzt", "Sal", "Cr", "Pr", "Cu", "Cts"],
            daysMin: ["Pz", "Pzt", "Sa", "Cr", "Pr", "Cu", "Ct"],
