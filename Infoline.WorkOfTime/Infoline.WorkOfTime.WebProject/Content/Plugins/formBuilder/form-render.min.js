    ...
    ! function (e) {
            ...
            y = function e(t, n, r) {
                ...
                for (var d in l)
                    if (l.hasOwnProperty(d)) {
                        var f = h(d),
                            p = Array.isArray(l[d]) ? E(l[d].join(" ").split(" ")).join(" ") : l[d];
                        u.setAttribute(f, p)
                    } return n && c[o](n),
                        function (e, t) {
                            if (t) {
            ...
            O = function (e) {
                ...
                if (t)
                    for (var r = t.getElementsByTagName("field"), o = 0; o < r.length; o++) {
                        ...
                        a && a.length && (i.values = w(a)), s && s.length && (i.userData = q(s)), n.push(i)
                    }
                return n
            },
            j = function (e) {
            ...
            L = function (t, n) {
                Array.isArray(t) || (t = [t]), t.forEach((function (t) {
                    var r = "href",
                        o = t,
                        i = "";
                    if ("object" == typeof t && (r = t.type || (t.style ? "inline" : "href"), i = t.id, t = "inline" == r ? t.style : t.href, o = i || t.href || t.style), !T(o, "css")) {
                        if ("href" == r) {
        ...
        var H = {
            ...
            merge: function e(t, n) {
                var r = $.extend({}, t, n);
                for (var o in n) r.hasOwnProperty(o) && (Array.isArray(n[o]) ? r[o] = Array.isArray(t[o]) ? E(t[o].concat(n[o])) : n[o] : "object" == typeof n[o] ? r[o] = e(t[o], n[o]) : r[o] = n[o]);
                return r
            },
            mobileClass: F,
            nameAttr: b,
            ...
            var r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
                ...
                s = t.I18N = function () {
                    ...
                    return e.prototype.processConfig = function (e) {
                        ...
                        return this.processConfig.call(this, $.extend({}, this.config, e)), this.setCurrent(this.locale)
                        ...
                        if (n) {
                            ...
                            this.langs["en-US"].minSelectionRequired = "En az 1 adet secim yapilmalidir."
                            return n
                        }
                        ...
                        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                            ...
                            r = this.langs[e] || {};
                        return this.langs[e] = $.extend({}, r, t, n), this.langs[e]
        ...
        var s = function (e) {
            ...
            return n = e, (t = u).prototype = Object.create(n.prototype), t.prototype.constructor = t, t.__proto__ = n, u.register = function (e, t) {
                ...
                for (var t = $.extend(this.config), n = 0, r = ["label", "description", "subtype", "id", "isPreview", "required", "title", "aria-required", "type"]; n < r.length; n++) {
                    var o = r[n];
        ...
        function y(e, t) {
            ...
            }) : (n = b(t), r = O.bind(null, n), o = function () {
                g(n)
            });
            return r(e),
                function (t) {
        ...
        var m = function (t) {
            ...
            return u.build = function () {
                ...
                if ((u.multiple || "checkbox-group" === i) && (u.name = u.name + "[]"), "checkbox-group" === i && u.required && (this.onRender = this.groupRequired), delete u.title, n) {
                    ...
                    for (var f = 0; f < n.length; f++) {
                        ...
                        var m = h,
                            ...
                            b = void 0 === g ? "" : g,
                            v = p(m, ["label"]);
                        if (v.id = u.id + "-" + f, v.selected && !o || delete v.selected, void 0 !== r && v.value === r && (v.selected = !0), d) {
                            var y = this.markup("option", document.createTextNode(b), v);
                            e.push(y)
                        } else {
                            var x = [b],
                                w = "formbuilder-" + c;
                            a && (w += "-inline"), v.type = c, v.selected && (v.checked = "checked", delete v.selected);
                            var q = this.markup("input", null, $.extend({}, u, v)),
                                O = {
                                    for: v.id
                                },
                                j = [q, this.markup("label", x, O)];
                            l && (O.className = "kc-toggle", x.unshift(q, this.markup("span")), j = this.markup("label", x, O));
                            var k = this.markup("div", j, {
                                className: w
                            });
                            e.push(k)
                        }
                ...
                if (this.config.userData) {
                    var datas = this.config.userData;
                    ...
                    for (var n = 0; n < this.config.values.length; n++) {
                      
                        if (datas.indexOf(this.config.values[n]) == -1)
                            this.config.values[n].selected = false;
                    }
                }
            }, a = i, l = [{
                key: "definition",
