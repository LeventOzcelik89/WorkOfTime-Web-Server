...
namespace Infoline.WorkOfTime.WebProject.Areas.FTM.Controllers
{
	public class VWFTM_TaskController : Controller
	{
		...
		public ContentResult DataSourceForStaffReport([DataSourceRequest] DataSourceRequest request, Guid[] assignableUsers, DateTime? planStartDate, DateTime? dueDate, Guid? customer, Guid? customerStorage)
		{
			...
			if (assignableUsers != null && !assignableUsers.Contains(Guid.Parse("00000000-0000-0000-0000-000000000000")) && planStartDate != null & dueDate != null)
			{
