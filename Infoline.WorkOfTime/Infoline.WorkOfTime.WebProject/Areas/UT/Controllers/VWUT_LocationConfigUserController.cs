...
namespace Infoline.WorkOfTime.WebProject.Areas.UT.Controllers
{
	public class VWUT_LocationConfigUserController : Controller
	{
		...
		[PageInfo("Lokasyon Takip Ekleme Insert Sayfası", SHRoles.IKYonetici, SHRoles.SahaGorevYonetici, SHRoles.SistemYonetici, SHRoles.SahaGorevOperator)]
		...
		[PageInfo("Lokasyon Takip Ekleme Insert ve Update Sayfası", SHRoles.IKYonetici, SHRoles.SahaGorevYonetici, SHRoles.SistemYonetici, SHRoles.SahaGorevOperator)]
