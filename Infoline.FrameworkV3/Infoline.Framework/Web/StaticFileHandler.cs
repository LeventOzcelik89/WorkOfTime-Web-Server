...
namespace Infoline.Web
{
    public class StaticFileHandler : IHttpHandler
    {
        ...
        {
            handler = typeof(System.Web.IHttpHandler).Assembly.GetType("System.Web.StaticFileHandler")
                .GetConstructors(System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic)[0]
                .Invoke(new object[0]) as IHttpHandler;
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (HostingEnvironment.VirtualPathProvider.FileExists(virtualPath))
            {
                ...
                var st = virtualFile.Open();
                int bytesRead = -1;
                context.Response.ContentType = MimeMapping.GetMimeMapping(virtualPath);
                context.Response.Cache.SetExpires(DateTime.Now.AddDays(1));
                context.Response.Expires = 60;
                context.Response.Cache.SetMaxAge(new TimeSpan(1, 0, 0));
                context.Response.Cache.SetLastModified(DateTime.Now.AddDays(-1));
             
                while ((bytesRead = st.Read(buff, 0, buff.Length)) > 0)
                {
