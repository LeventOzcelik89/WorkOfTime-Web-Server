...
namespace Infoline.Framework.Helper
{
    ...
    {
        public static void Write(IEnumerable<Dictionary<string, object>> datas, Dictionary<string, object> fields, string path)
        {
        ...
        public static void Write<T>(this IEnumerable<T> datas, Dictionary<string, object> fields, string path)
        {
