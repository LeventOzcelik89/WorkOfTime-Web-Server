...
namespace Infoline.Framework.Helper
{
    public class FileHelper
    {
        ...
        private static Dictionary<string, string> ExtensionToContentTypeList = new Dictionary<string, string>{
        ...
        {
            return ExtensionToContentTypeList.Where(a => a.Value == contentType).Select(a => a.Key).FirstOrDefault();
        }
